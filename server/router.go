...
func Init(e *gin.Engine) {
	...
	g.GET("/ad/*path", middlewares.PathParse, archiveSignCheck, downloadLimiter, quotaLimiter, handles.ArchiveDown)
	g.GET("/ap/*path", middlewares.PathParse, archiveSignCheck, downloadLimiter, quotaLimiter, handles.ArchiveProxy)
	g.GET("/ae/*path", middlewares.PathParse, archiveSignCheck, downloadLimiter, quotaLimiter, handles.ArchiveInternalExtract)
	...
	g.GET("/sd/:sid", middlewares.EmptyPathParse, middlewares.SharingIdParse, downloadLimiter, quotaLimiter, handles.SharingDown)
	g.GET("/sd/:sid/*path", middlewares.PathParse, middlewares.SharingIdParse, downloadLimiter, quotaLimiter, handles.SharingDown)
	...
	g.GET("/sad/:sid", middlewares.EmptyPathParse, middlewares.SharingIdParse, downloadLimiter, quotaLimiter, handles.SharingArchiveExtract)
	g.GET("/sad/:sid/*path", middlewares.PathParse, middlewares.SharingIdParse, downloadLimiter, quotaLimiter, handles.SharingArchiveExtract)
